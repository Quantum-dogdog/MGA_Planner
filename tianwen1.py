...
jd = 2459255.5  #2457061.5（2015年2月8日）是时间
...
position = kernel[4,499].compute(2459053.5)   #火星和火星barycenter的相对距离
...
position = kernel[0,3].compute(2459053.5)
position -= kernel[3,399].compute(2459053.5)      
